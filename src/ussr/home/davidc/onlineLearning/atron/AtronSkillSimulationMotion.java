...
public class AtronSkillSimulationMotion extends AtronSkillSimulation {
	float oldDist = 0; 
	...
	private static void initLogFiles() {
		DataLogger.init("exp-"+robotType+"-"+System.currentTimeMillis()%1000);
	...
	protected void changeWorldHook(WorldDescription world) {
		initLogFiles();
		if(loadSkillsFromFile) loadSkills();

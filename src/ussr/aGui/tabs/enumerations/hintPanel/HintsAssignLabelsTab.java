...
public enum HintsAssignLabelsTab implements HintsTabsInter{
    ...
    ENTITY_CHOSEN("Select chosen entity in simulation environment in order to read in its labels into the table. Next modify the labels in the table (delete or type in desired ones) and select button for assigning labels."),

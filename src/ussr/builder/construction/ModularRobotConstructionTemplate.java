...
public abstract class ModularRobotConstructionTemplate implements ConstructionTemplate {	
	...
	public void moveModuleAccording(int connectorNr, Module selectedModule, Module newMovableModule){
		...
		if (selectedModuleType.contains("Odin")){//if it is heterogeneous like Odin
			moveModuleComponentAccording(connectorNr,selectedModule, (JMEModuleComponent) newMovableModule.getComponent(0), null);
			...
			for (int component=0; component<amountComponents;component++){
				...
				moveModuleComponentAccording(connectorNr,selectedModule, movableModuleComponent, rotationQuatComponent);

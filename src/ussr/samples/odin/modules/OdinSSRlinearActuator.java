...
/**
 * Odin muscle modified to fit Harvard SSR's linear actuator
 */
public abstract class OdinSSRlinearActuator extends Odin {

	/**
	 * A contractive rod with a connector in each end
	 */
	public RobotDescription getDescription() {
		RobotDescription description = new RobotDescription("OdinSSRlinearActuator");

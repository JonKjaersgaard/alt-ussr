/**
 * This simple remote control for the USSR ATRON car is based on the
 * "Simple TCP Chat" application from  
...
public class RemoteControl implements Runnable {
   ...
   public final static RemoteControl tcpObj = new RemoteControl();
...
private static AbstractButton neutralButton;
private static AbstractButton rigthButton;
private static JButton reverseButton;
private static String dir ="0";
private static String rot ="0";
...
//      chatPane.add(chatTextPane, BorderLayout.CENTER);
      ...
      forwardButton.setMnemonic(KeyEvent.VK_C);
      forwardButton.setActionCommand("forward");
      forwardButton.addActionListener(buttonListener);

      stopButton = new JButton("Stop");
      stopButton.setMnemonic(KeyEvent.VK_C);
      stopButton.setActionCommand("stop");
      stopButton.addActionListener(buttonListener);

      reverseButton = new JButton("Reverse");
      reverseButton.setMnemonic(KeyEvent.VK_D);
      ...
      buttonPane.add(new JLabel("Remote control"));
      buttonPane.add(forwardButton);
      buttonPane.add(stopButton);
      buttonPane.add(reverseButton);

      
      JPanel buttonPane1 = new JPanel(new GridLayout(1, 3));
      ActionAdapter buttonListener1 = new ActionAdapter() {
            public void actionPerformed(ActionEvent e) {
               // Request a connection initiation
    			...
    			if (e.getActionCommand().equals("rigth")) {
    				rot = "1";
    			}
    			sendString(dir+":"+rot);
            }
      ...
      leftButton.setMnemonic(KeyEvent.VK_C);
      leftButton.setActionCommand("left");
      leftButton.addActionListener(buttonListener1);

      neutralButton = new JButton("Neutral");
      neutralButton.setMnemonic(KeyEvent.VK_C);
      neutralButton.setActionCommand("neutral");
      neutralButton.addActionListener(buttonListener1);

      rigthButton = new JButton("Rigth");
      rigthButton.setMnemonic(KeyEvent.VK_D);
      rigthButton.setActionCommand("rigth");
      rigthButton.addActionListener(buttonListener1);
      ...
      buttonPane1.add(neutralButton);
      buttonPane1.add(rigthButton);
      

      chatPane.add(buttonPane, BorderLayout.NORTH);
      chatPane.add(new JLabel("Steering"), BorderLayout.CENTER);
      chatPane.add(buttonPane1, BorderLayout.SOUTH);
      ...
      mainFrame = new JFrame("Simple ATRON car remote control");

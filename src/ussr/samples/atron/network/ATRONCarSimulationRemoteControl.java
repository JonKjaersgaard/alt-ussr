...
import ussr.samples.atron.ATRONCarSimulation.ObstacleType;
...
public class ATRONCarSimulationRemoteControl extends GenericATRONSimulation {
	...
	protected ArrayList<ModulePosition> buildCar() {
    	...
    	mPos.add(new ModulePosition("driver0:10000", new VectorDescription(2*0*unit,0*unit-Yoffset,0*unit), rotation_EW));
    	...
    	mPos.add(new ModulePosition("wheel1:10001", new VectorDescription(-1*unit,-2*unit-Yoffset,1*unit), rotation_SN));

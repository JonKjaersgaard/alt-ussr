...
public class EightSimulation extends GenericATRONSimulation {
	...
	protected ArrayList<ModulePosition> buildEight() {
    	...
    	mPos.add(new ModulePosition("2", ";portRC=9902;portEvent=9903;radio=disabled", new VectorDescription(1*ATRON.UNIT,0*ATRON.UNIT-Yoffset,-1*ATRON.UNIT), ATRON.ROTATION_SN));
    	mPos.add(new ModulePosition("3", ";portRC=9904;portEvent=9905;radio=disabled", new VectorDescription(1*ATRON.UNIT,0*ATRON.UNIT-Yoffset,1*ATRON.UNIT), ATRON.ROTATION_NS));
    	mPos.add(new ModulePosition("4", ";portRC=9906;portEvent=9907;radio=disabled", new VectorDescription(2*ATRON.UNIT,0*ATRON.UNIT-Yoffset,0*ATRON.UNIT), ATRON.ROTATION_WE));
    	mPos.add(new ModulePosition("5", ";portRC=9908;portEvent=9909;radio=disabled", new VectorDescription(-1*ATRON.UNIT,0*ATRON.UNIT-Yoffset,1*ATRON.UNIT), ATRON.ROTATION_SN));
    	mPos.add(new ModulePosition("6", ";portRC=9910;portEvent=9911;radio=disabled", new VectorDescription(0*ATRON.UNIT,0*ATRON.UNIT-Yoffset,2*ATRON.UNIT), ATRON.ROTATION_WE));
    	mPos.add(new ModulePosition("7", ";portRC=9912;portEvent=9913;radio=disabled", new VectorDescription(3*ATRON.UNIT,0*ATRON.UNIT-Yoffset,-1*ATRON.UNIT), ATRON.ROTATION_NS));
    	mPos.add(new ModulePosition("8", ";portRC=9914;portEvent=9915;radio=disabled", new VectorDescription(2*ATRON.UNIT,0*ATRON.UNIT-Yoffset,-2*ATRON.UNIT), ATRON.ROTATION_EW));
    	return mPos;
	}

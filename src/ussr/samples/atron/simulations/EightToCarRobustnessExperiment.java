 ...
 * @author ups
 */ 
public class EightToCarRobustnessExperiment extends GenericATRONSimulation {
    ...
    protected class EightController extends ATRONController {
        ...
        public void activate_eight2car() {
            ...
            if(getMyID()==0) {
                token[0] = 0;
                module.getSimulation().waitForPhysicsTimestep(new TimedPhysicsObserver(maxTime) {

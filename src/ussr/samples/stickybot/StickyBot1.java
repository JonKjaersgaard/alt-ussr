 ...
 * @author ups
 */
public class StickyBot1 implements Robot {
    ...
    public RobotDescription getDescription() {
        ...
        GeometryDescription[] connectorGeometry = new GeometryDescription[] { new SphereShape(SCALE*2.1f) };
        ...
        common.setType( ConnectorDescription.Type.VELCRO_CONNECTOR);
        common.setMaxConnectionDistance(SCALE*2.2f*2);
        ConnectorDescription[] connectors = new ConnectorDescription[] {
                new ConnectorDescription(common, new VectorDescription(0, 0, 0))
        };

 ...
 * @author ups
 */
public class StickyBot14 implements Robot {
    
    public static final float SCALE = 0.1f; 
    public static final float CONNECTORSIZE = SCALE*0.9f;
    ...
    public RobotDescription getDescription() {
        ...
        GeometryDescription[] connectorGeometry = new GeometryDescription[] { new SphereShape(CONNECTORSIZE) };
        ...
        common.setMaxConnectionDistance(CONNECTORSIZE*2);
        float base = 2.0f*SCALE;
        float offset = 1.1f*SCALE;
        ConnectorDescription[] connectors = new ConnectorDescription[] {
                ...
                new ConnectorDescription(common, new VectorDescription(0, 0, base)), 
                // 4 on northern hemisphere
                new ConnectorDescription(common, new VectorDescription(offset,offset,offset)),
                new ConnectorDescription(common, new VectorDescription(offset,offset,-offset)),
                new ConnectorDescription(common, new VectorDescription(-offset,offset,offset)),
                new ConnectorDescription(common, new VectorDescription(-offset,offset,-offset)),
                // 4 on southern hemisphere
                new ConnectorDescription(common, new VectorDescription(offset,-offset,offset)),
                new ConnectorDescription(common, new VectorDescription(offset,-offset,-offset)),
                new ConnectorDescription(common, new VectorDescription(-offset,-offset,offset)),
                new ConnectorDescription(common, new VectorDescription(-offset,-offset,-offset))

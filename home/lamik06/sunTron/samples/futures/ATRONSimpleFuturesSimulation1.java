 ...
 *
 */
public class ATRONSimpleFuturesSimulation1 extends GenericATRONSimulation {
	
	public static void main( String[] args ) {
        new ATRONSimpleFuturesSimulation1().main();
    }
	
	protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                return (Controller) new ATRONSimpleFuturesController1();
            }
        };
    }

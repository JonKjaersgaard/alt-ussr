 ...
 */
package sunTron.samples.eightToCar;
 ...
 * @author ups
 */
public class EightToCarSimulationJLamik06 extends GenericATRONSimulation {
    ...
    byte[] testMessage = new byte[3];
    public static void main(String argv[]) {
        new EightToCarSimulationJLamik06().main();
    }
...
//                    while (!isDisconnected(0) || !isDisconnected(2)) super.yield();
//                    token[0]=67;
//                    break;
case 65:
    disconnect_module(0,5);
    ...
    break;
        ...
        public void handleMessage(byte[] incoming, int messageSize, int channel) {
            ...
            } else if(incoming[2]==99) {
            	 System.out.println("Test print -> Module "+this.getMyID()+" -> message: "+ incoming[1]);

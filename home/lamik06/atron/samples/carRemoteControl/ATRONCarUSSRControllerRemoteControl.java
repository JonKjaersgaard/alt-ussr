 ...
 *
 */
public class ATRONCarUSSRControllerRemoteControl extends ATRONSPOTController {
    ...
    public void activate() {
        ...
        if(module.getProperty("name").contains(":"))
        	(remoteControllerConnection = new RemoteControllerConnection()).openServerSocketPortInHex(module);
...
//		        		  			}
		        		        ...
		        		        switch (messageRecieve[1]) {
			        				case 1:
			        					module.setColor(java.awt.Color.RED);
			        					break;
			        				case 2:
			        					module.setColor(java.awt.Color.YELLOW);
			        					break;
			        				default:
			        					module.setColor(java.awt.Color.GREEN);
			        					break;
		        		        }

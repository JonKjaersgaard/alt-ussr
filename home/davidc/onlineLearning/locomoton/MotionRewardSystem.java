...
import onlineLearning.RewardSystem;
...
public class MotionRewardSystem implements RewardSystem {
	...
	public MotionRewardSystem(SkillController controller, PhysicsSimulation simulation) {
    ...
    public Vector3f getRobotCM() {
        ...
        for(int i=0;i<simulation.getModules().size();i++) {
        	if(isInSameRobot(simulation.getModules().get(i))) {

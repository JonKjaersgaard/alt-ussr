...
public final class AGreaterThanBinaryExp extends PBinaryExp
{
    private PExp _left_;
    private TGt _gt_;
    private PExp _right_;

    public AGreaterThanBinaryExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGreaterThanBinaryExp(
    ...
    {
        ((Analysis) sw).caseAGreaterThanBinaryExp(this);
    }

 ...
 * @author  Konstantinas
 */
public class QuickPrototyping3 extends javax.swing.JFrame {
   ...
   private static final int amountOdinBallConnectors = 11;
    ...
    public QuickPrototyping3(/*JMEBasicGraphicalSimulation simulation*/) {
        initComponents();
        //Set to generic view      
...
//    jToolBar3.setVisible(true);
   ...
   /*public static void activate(final JMEBasicGraphicalSimulation simulation) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				QuickPrototyping1 quickPrototyping = new QuickPrototyping1(simulation);
                quickPrototyping.setSize(320, 320);
                quickPrototyping.setVisible(true); 
			}
		});

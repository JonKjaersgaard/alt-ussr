 ...
 * @author ups
 */ 
public class SnakeRobustnessExperimentBroadcast extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                StateMachine machine = new snakeGen_seq();
                return new ATRONStateMachineAPI(machine,SnakeRobustnessExperimentBroadcast.this);
            }
        };
    }

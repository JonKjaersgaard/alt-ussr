 ...
 * @author ups
 */ 
public class RotationExperiment5seq extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    public static void main(String argv[]) {
        ...
        new RotationExperiment5seq().main(); 
    }
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                ...
                return new ATRONStateMachineAPI(machine,RotationExperiment5seq.this);
            }
        };
    }

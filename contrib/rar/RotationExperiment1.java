 ...
 * @author ups
 */ 
public class RotationExperiment1 extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                ...
                return new ATRONStateMachineAPI(machine,RotationExperiment1.this);
            }
        };
    }

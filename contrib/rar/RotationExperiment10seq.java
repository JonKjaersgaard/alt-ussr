 ...
 * @author ups
 */ 
public class RotationExperiment10seq extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    public static void main(String argv[]) {
        ...
        new RotationExperiment10seq().main(); 
    }
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                StateMachine machine = new rotateGen10s();
                return new ATRONStateMachineAPI(machine,RotationExperiment10seq.this);
            }
        };
    }

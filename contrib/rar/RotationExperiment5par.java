...
import gen.rotateGen10p;
import gen.rotateGen10s;
import gen.rotateGen5p;
import gen.snakeGen_seq;
 ...
 * @author ups
 */ 
public class RotationExperiment5par extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    public static void main(String argv[]) {
        ...
        ParameterHolder.set(new EightToCarRobustnessBatch.Parameters(null,0,0.0f,0.0f,0.0f,Float.MAX_VALUE,10000f,0.0f,1));
        new RotationExperiment5par().main(); 
    }
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                StateMachine machine = new rotateGen5p();
                return new ATRONStateMachineAPI(machine,RotationExperiment5par.this);
            }
        };
    }

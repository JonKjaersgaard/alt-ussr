...
import robustReversible.gen.rotateGen20p;
import robustReversible.gen.rotateGen20s;
 ...
 * @author ups
 */ 
public class RotationExperiment20par extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    public static void main(String argv[]) {
        ...
        new RotationExperiment20par().main(); 
    }
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                StateMachine machine = new rotateGen20p();
                return new ATRONStateMachineAPI(machine,RotationExperiment20par.this);
            }
        };
    }
    ...
    protected ArrayList<ModulePosition> buildRobot() {
        ...
        return builder.buildAsNamedLattice(20, 10, 1, 2, namer, selector, ATRON.UNIT);
    }
    @Override
    protected void setupPhysicsHook() {
        super.setupPhysicsHook();
        DistributedStateManager.MAX_N_PENDING_STATES = 20;
    }
}

 ...
 * @author ups
 */ 
public class RotationExperiment20seq extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    public static void main(String argv[]) {
        ...
        new RotationExperiment20seq().main(); 
    }
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                StateMachine machine = new rotateGen20s();
                return new ATRONStateMachineAPI(machine,RotationExperiment20seq.this);
            }
        };
    }

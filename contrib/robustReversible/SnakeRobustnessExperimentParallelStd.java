...
import robustReversible.gen.snakeGen_par;
 ...
 * @author ups
 */ 
public class SnakeRobustnessExperimentParallelStd extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {

    public static void main(String argv[]) {
        if(ParameterHolder.get()==null)
            //ParameterHolder.set(new Parameters(0,0.5f,0.75f,0.0f,Float.MAX_VALUE));
        ParameterHolder.set(new EightToCarRobustnessBatch.Parameters(null,0,0.0f,0.0f,0.0f,Float.MAX_VALUE,100f,0,1));

        new SnakeRobustnessExperimentParallelStd().main(); 
    }
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                StateMachine machine = new snakeGen_par();
                return new ATRONStateMachineAPI(machine,SnakeRobustnessExperimentParallelStd.this);
            }
        };
    }

...
import robustReversible.gen.rotateGen1;
 ...
 * @author ups
 */ 
public class RotationExperiment01 extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    protected Robot getRobot() {
        return new ATRON() {
            public Controller createController() {
                StateMachine machine = new rotateGen1();
                return new ATRONStateMachineAPI(machine,RotationExperiment01.this);
            }
        };
    }
    ...
    protected ArrayList<ModulePosition> buildRobot() {
        ...
        return builder.buildAsNamedLattice(1, 5, 1, 2, namer, selector, ATRON.UNIT);
    }
    @Override

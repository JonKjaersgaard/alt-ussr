 ...
 *
 */
public class SimpleVehicle_SharedBehaviors_Controller extends ATRONFramework {
    
    static final int REVERSE_TIME = 2;
    
    public class EvasionBehavior extends Collaboration {
        private ModuleSelector<CarModule> car;
        public final Script twoWheelerEvasion = makeAtomicScript(
                    car.all(IWheel.class).reverse(),
                    sleep(4),
    ...
    public class Driver extends CarModule {
        ...
        @Handler(proximity={1,3}) public void isObstacle() { evasion.twoWheelerEvasion.run(); }
    }

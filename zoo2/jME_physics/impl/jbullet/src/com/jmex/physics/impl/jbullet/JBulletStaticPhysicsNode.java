...
public class JBulletStaticPhysicsNode extends StaticPhysicsNode implements
    ...
    public void rebuildRigidBody() {
        ...
        if ( collisionShapes.size() == 0 ) {
            body = new JBulletRigidBody( 0, motionState, null, new javax.vecmath.Vector3f() );
            ...
            mainShape.setLocalScaling( VecmathConverter.convert( collisionShapes.get( 0 ).getWorldScale() ) );

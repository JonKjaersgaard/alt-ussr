 ...
 * @author ups
 */ 
public class EightToCarRobustnessExperimentBroadcast extends EightToCarRobustnessExperiment implements ExperimentResultRegistrant {
    ...
    public static void main(String argv[]) {
        ...
        ParameterHolder.set(new EightToCarRobustnessBatch.Parameters(null,0,0.0f,0.0f,0.0f,Float.MAX_VALUE,0.1f,4.0f,17));
